  ...
  return (
    <div className="flex h-screen bg-slate-50 dark:bg-neutral-900 overflow-hidden">
      ...
      <div className="flex-1 p-6 bg-slate-50 dark:bg-neutral-900 overflow-y-auto" style={{ order: 1 }}>
        {/* Abas Principal */}
        <div className="mb-6 flex gap-1 p-1 bg-slate-100 dark:bg-neutral-800 rounded-xl border border-slate-200 dark:border-neutral-700">
          <button
            type="button"
            onClick={() => setAbaPrincipal('admissao')}
            className={`flex-1 flex items-center justify-center gap-2.5 px-5 py-3 rounded-lg text-sm font-semibold transition-all duration-200 ${
              abaPrincipal === 'admissao'
                ? 'bg-white dark:bg-neutral-700 text-blue-600 dark:text-blue-400 shadow-sm border border-slate-200 dark:border-neutral-600'
                : 'text-slate-500 dark:text-neutral-400 hover:text-slate-700 dark:hover:text-neutral-200'
            }`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
            Sistema Admissão com OCR
            {abaPrincipal === 'admissao' && (
          ...
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-2.5 px-5 py-3 rounded-lg text-sm font-semibold transition-all duration-200 ${
              abaPrincipal === 'visualizar'
                ? 'bg-white dark:bg-neutral-700 text-slate-700 dark:text-neutral-200 shadow-sm border border-slate-200 dark:border-neutral-600'
                : 'text-slate-500 dark:text-neutral-400 hover:text-slate-700 dark:hover:text-neutral-200'
            }`}
          >
